...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('pembelian', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_pegawai'); // foreign key to admins
            ...
            $table->foreign('id_pegawai')->references('id')->on('admins');

            $table->index('disetujui_oleh');
            $table->foreign('disetujui_oleh')->references('id')->on('admins');
        });
    }
